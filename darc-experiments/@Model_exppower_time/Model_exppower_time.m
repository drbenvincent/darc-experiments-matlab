classdef Model_exppower_time < Model & ChoiceFuncPsychometric & experiment_type_delay
    %Model_exppower_time
    ...
    methods
        ...
        function obj = Model_exppower_time(varargin)
            % Compose a model ---------------------------------------------
            ...
            obj.delayDiscountingFunction    = @delayExpPower;
            ...
            obj.priors.k = makedist('tLocationScale', 'mu',0, 'sigma', 0.1, 'nu', 1);
